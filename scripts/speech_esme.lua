return {
	ACTIONFAIL =
	{
		SHAVE =
		{
			AWAKEBEEFALO = "Bet it'd be hard to shave when it's moving.",
			GENERIC = "I can't shave that!",
			NOBITS = "There ain't nothing to shave.",
		},
		STORE =
		{
			GENERIC = "There's nowhere to put it.",
			NOTALLOWED = "That ain't its proper place.",
		},
	},
	ACTIONFAIL_GENERIC = "I ain't doing that.",
	ANNOUNCE_ADVENTUREFAIL = "I'll not be beat.",
	ANNOUNCE_BEES = "The hive is coming.",
	ANNOUNCE_BOOMERANG = "Nonsense, why would I want a weapon to hit me?",
	ANNOUNCE_CHARLIE = "I'm not alone in this darkness.",
	ANNOUNCE_CHARLIE_ATTACK = "I should be the most dangerous thing here.",
	ANNOUNCE_COLD = "I may need another vest at this temperature.",
	ANNOUNCE_HOT = "Never gets this hot in Lancre.",
	ANNOUNCE_CRAFTING_FAIL = "It'd work with all the pieces.",
	ANNOUNCE_DEERCLOPS = "I ain't heard somethin that big before.",
	ANNOUNCE_DUSK = "It's become dusk.",
	ANNOUNCE_EAT =
	{
		GENERIC = "That'll do nicely.",
		PAINFUL = "It's not good for the health.",
		SPOILED = "It went off.",
		STALE = "It's on the turn.",
		INVALID = "I ain't gonna eat that.",
	},
	ANNOUNCE_ENTER_DARK = "Blacker than the inside of a cat.",
	ANNOUNCE_ENTER_LIGHT = "I can see again!",
	ANNOUNCE_FREEDOM = "Free to go home to Lancre",
	ANNOUNCE_HIGHRESEARCH = "I might've learnt something from that.",
	ANNOUNCE_HOUNDS = "Those don't sound like normal wolves.",
	ANNOUNCE_HUNGRY = "I could use a bite to eat.",
	...
	ANNOUNCE_INV_FULL = "There's only so much I can carry.",
	ANNOUNCE_KNOCKEDOUT = "Ugh, my head!",
	ANNOUNCE_LOWRESEARCH = "Hah! I knew that already.",
	ANNOUNCE_MOSQUITOS = "Hate 'em bloodsuckers.",
	ANNOUNCE_NODANGERSLEEP = "I ain't sleeping with danger on my tail.",
	ANNOUNCE_NODAYSLEEP = "I ain't sleeping in the day - I ain't an owl.",
	ANNOUNCE_NODAYSLEEP_CAVE = "I'm not tired.",
	ANNOUNCE_NOHUNGERSLEEP = "I'm peckish, I ain't sleeping yet.",
	ANNOUNCE_NOSLEEPONFIRE = "Ain't no one who sleeps in a fire that don't get burnt.",
	ANNOUNCE_NODANGERSIESTA = "I ain't resting with danger lurking around.",
	ANNOUNCE_NONIGHTSIESTA = "Forty winks is a better option.",
	ANNOUNCE_NONIGHTSIESTA_CAVE = "This ain't a nice comfy cottage.",
	ANNOUNCE_NOHUNGERSIESTA = "I'm peckish, I need to eat before resting.",
	ANNOUNCE_NO_TRAP = "Well, that was easy.",
	ANNOUNCE_PECKED = "There will be a reckoning!",
	ANNOUNCE_QUAKE = "The ground's moving...",
	ANNOUNCE_RESEARCH = "Never stop learning.",
	ANNOUNCE_SHELTER = "It ain't the best shelter but it's better than nothing.",
	ANNOUNCE_THORNS = "Worse spikes than a blackberry bush.",
	ANNOUNCE_BURNT = "The burn will heal.",
	ANNOUNCE_TORCH_OUT = "It's run out of fuel.",
	ANNOUNCE_TRAP_WENT_OFF = "Oops.",
	ANNOUNCE_UNIMPLEMENTED = "OW! I don't think it's ready yet.",
	ANNOUNCE_WORMHOLE = "It'd be a fool choice to go through those much.",
	ANNOUNCE_CANFIX = "It shouldn't be hard to fix.",
	ANNOUNCE_ACCOMPLISHMENT = "It's done.",
	ANNOUNCE_ACCOMPLISHMENT_DONE = "I'll tell Gytha all about this when I'm home.",	
	ANNOUNCE_INSUFFICIENTFERTILIZER = "It needs more animal-leavings to grow proper.",
	ANNOUNCE_TOOL_SLIP = "My hands might as well've been greased with butter.",
	ANNOUNCE_LIGHTNING_DAMAGE_AVOIDED = "No lightning is going to strike me.",

	ANNOUNCE_DAMP = "This dampness is less than ideal.",
	ANNOUNCE_WET = "I'd like to get dry soon.",
	ANNOUNCE_WETTER = "It's rather wet.",
	ANNOUNCE_SOAKED = "I'm drenched to the bone.",
	
	BATTLECRY =
	{
		GENERIC = "It don't stand a chance.",
		PIG = "Pigs ain't as crafty as me.",
		PREY = "I need to eat.",
